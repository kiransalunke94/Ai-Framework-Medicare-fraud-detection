...
df_2.writeStream \
    .format(source = "csv") \
    .option("path","hdfs://localhost:9000/kiran/medicare/drug_data") \
    .option("checkpointlocation","hdfs://localhost:9000/kiran/drug_data_checkpoint") \
    .start()
...
df_2.writeStream.format("com.mongodb.spark.sql.connector.MongoTableProvider") \
    ...
    .option('spark.mongodb.collection', 'drug_data_test') \
